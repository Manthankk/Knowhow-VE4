...
const Navbar = () => {
  return (
    <nav className="bg-gradient-to-r from-teal-100 to-teal-50 shadow-lg"> 
      <div className="max-w-8xl mx-auto px-7">
        <div className="flex justify-between items-center h-24"> 
          <Link to="/" className="flex items-center space-x-3">
            <span className="text-4xl font-bold text-teal-800">HomoConnect</span> 
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-16"> 
            ...
            <Link to="/cart" className="relative">
              <ShoppingCart className="h-8 w-8 text-teal-800 hover:text-teal-600 transition" /> 
            </Link>
            <Link to="/health-profile">
              <User className="h-8 w-8 text-teal-800 hover:text-teal-600 transition" /> 
            </Link>
          </div>
          
          <div className="md:hidden">
            <Menu className="h-8 w-8 text-teal-800" /> 
          </div>
        </div>
      </div>
    </nav>
